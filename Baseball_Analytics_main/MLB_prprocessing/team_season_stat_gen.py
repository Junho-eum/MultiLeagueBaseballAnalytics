...
if __name__ == "__main__":
    final_df = preprocess_league_data('../datasets/MLB_datasets/mlb_win_losses.csv', '../datasets/MLB_datasets/mlb_data.csv', '../datasets/MLB_datasets/mlb_teams.csv')
    # output the data
    final_df.to_csv('../datasets/MLB_datasets/MLB_team_season_statistics.csv', index=False)
